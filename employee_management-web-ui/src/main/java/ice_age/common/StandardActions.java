...
import static ice_age.common.StandardActionsStyles.STANDARD_ACTION_COLOUR;
import static ice_age.common.StandardMessages.DELETE_CONFIRMATION;
...
public enum StandardActions {
    ...
    DELETE_ACTION {
        ...
        @Override
        public EntityActionConfig mkAction(final Class<? extends AbstractEntity<?>> entityType, final PrefDim prefDim) {
            throw new UnsupportedOperationException("It's challenging to set preferred dimension for noUI master!");
        }
